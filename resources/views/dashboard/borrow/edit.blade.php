...
@section('main')
    <div class="card shadow-lg border-0 border-radius-xl">
        ...
        <div class="card-body">
            <form action="{{ route('borrow.store', $borrow->id) }}" method="POST" role="form">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="datetime-local" name="tgl_pinjam" value="{{ old('tgl_pinjam', $borrow->tgl_pinjam) }}" id="tgl_pinjam" class="form-control form-control-lg" required>
                        </div>
                    </div>
