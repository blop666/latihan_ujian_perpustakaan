                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="tgl_nota" value="{{ old('tgl_nota', $purchase->tgl_nota) }}" class="form-control form-control-lg border-radius-md"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <select name="id_distributor" class="form-select form-control-lg border-radius-md"  required>
                                {{-- <option value="{{ old('nama_distributor', $purchase->distributor->nama) }}"></option> --}}
