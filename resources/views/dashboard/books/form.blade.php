...
@section('main')
        ...
        <div class="formbold-form-wrapper">
            <form action="{{ route('books.store') }}" method="POST" id="form">
                ...
                <div class="flex flex-wrap formbold--mx-3">
                    ...
                    <div class="w-full sm:w-half formbold-px-3">
                        <div class="formbold-mb-5">
                            ...
                            <input type="jenis" name="jenis" id="jenis" placeholder="Last Name"
                                class="formbold-form-input" />
                        </div>
                    </div>
                </div>
                ...
                <div class="formbold-mb-5">
                    ...
                    <input type="text" name="penulis" id="penulis" placeholder="5" class="formbold-form-input" />
                </div>
                ...
                <div class="flex flex-wrap formbold--mx-3">
                    <div class="w-full sm:w-half formbold-px-3">
                        <div class="formbold-mb-5 w-full">
                            ...
                            <input type="date" name="tahun_terbit" id="tahun_terbit" class="formbold-form-input" />
                        </div>
                    </div>
                    ...
                    <div class="formbold-mb-5">
                        ...
                        <input type="text" name="penerbit" id="penerbit" placeholder="5"
                            class="formbold-form-input" />
                    </div>
                    ...
                    <div class="w-full sm:w-half formbold-px-3">
                        <div class="formbold-mb-5">
                            ...
                            <input type="number" name="stok" id="stok" class="formbold-form-input" />
                        </div>
                    </div>
                </div>

                <div>
                    <button class="formbold-btn" id="btnsubmit">Submit</button>
                </div>
            </form>
        </div>
    </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            var btnsimpan = document.getElementById('btnsubmit');
            ...
            btnsimpan.addEventListener('click', function(e) {
                ...
                if (penulis.value.trim() === '') {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Oops...',
                        text: 'Penulis wajib diisi'
                    });
                    penulis.focus();
                    return;
                }

                if (tahun_terbit.value === '') {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Oops...',
                        text: 'Tahun terbit wajib diisi'
                    });
                    tahun_terbit.focus();
                    return;
                }
